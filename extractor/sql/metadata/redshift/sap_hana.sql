    ...
    FROM (
        ...
        SELECT DISTINCT
			...
			CASE DATA_TYPE_NAME
				...
				WHEN 'VARCHAR'		THEN 'varchar'||'(' || TO_BIGINT( round(CASE WHEN MOD("LENGTH",2) = 0 THEN ("LENGTH" + 1) * (("LENGTH" + 1) / 2) else ("LENGTH" + 1) * (("LENGTH" + 1)/ 2) end, 0)) ||')'
				WHEN 'VARBINARY'	THEN 'varchar'||'(' || TO_BIGINT( round(CASE WHEN MOD("LENGTH",2) = 0 THEN ("LENGTH" + 1) * (("LENGTH" + 1) / 2) else ("LENGTH" + 1) * (("LENGTH" + 1)/ 2) end, 0)) ||')'
				WHEN 'NVARCHAR'		THEN 'varchar'||'(' || TO_BIGINT( round(CASE WHEN MOD("LENGTH",2) = 0 THEN ("LENGTH" + 1) * (("LENGTH" + 1) / 2) else ("LENGTH" + 1) * (("LENGTH" + 1) /2) end, 0)) ||')'
				WHEN 'CHAR'			THEN 'varchar'||'(' || TO_BIGINT( round(CASE WHEN MOD("LENGTH",2) = 0 THEN ("LENGTH" + 1) * (("LENGTH" + 1) / 2) else ("LENGTH" + 1) * (("LENGTH" + 1) /2) end, 0)) ||')'
