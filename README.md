...
|SPECTRUM| EXPORT_BUCKET_DEFAULT      | Identifica o bucket para exportação de dados.                                                                                                                                                                                                                                                                                                     |
...
| SPECTRUM | EXPORT_PROFILE | Identifica qual perfil de configuração do S3 deve ser usado no processo de exportação. Default: default                                                                                                                                                                                                                                                                                              |
