...
|--------------------|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                    | MODULE                     | Identifica o módulo que será utilizado                                                                                                                                                                                                                                                                                                            |
|                    | ALLOW_DUPLICATED           | Identifica se campos com custom primary key duplicadas serão inseridas na tabela.                                                                                                                                                                                                                                                                 |
...
|                    | EXPORT_SPREADSHEET_DEFAULT | Identifica o Id da Google spreadsheet.                                                                                                                                                                                                                                                                                                            |
|                    | EXPORT_SHEET_DEFAULT       | Identifica o nome da página (guia).                                                                                                                                                                                                                                                                                                               |
|                    | EXPORT_SHEETS_METHOD       | Identifica o tipo de atualização da planilha [0: FULL, 1:APPEND], 0 é o padrão.                                                                                                                                                                                                                                                                   |
